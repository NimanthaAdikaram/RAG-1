...
class RAGPaLMQuery:
    def __init__(self):
        ...
        self.service_context = ServiceContext.from_defaults(llm=self.llm, embed_model=self.embed_model, chunk_size=1000, chunk_overlap=50)
        ...
        self.query_engine = self.index.as_chat_engine(response_mode='tree_summarize')
